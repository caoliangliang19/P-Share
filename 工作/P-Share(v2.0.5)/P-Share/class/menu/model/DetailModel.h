...
@property (nonatomic,strong) NSString *sharePriceComment;// 价格描述;
@property (nonatomic,strong) NSString *vipSharePrice;//vip价格
@property (nonatomic,strong) NSString *vipSharePriceComment;//vip价格描述
@property (nonatomic,strong) NSString *vipStartTime;
@property (nonatomic,strong) NSString *vipStopTime;
