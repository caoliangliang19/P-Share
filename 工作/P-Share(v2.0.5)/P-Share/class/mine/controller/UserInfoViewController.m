...
- (void)setDufault
{
    ...
    self.integralNumLabel.textColor = NEWMAIN_COLOR;
    //设置用户基本信息
...
//        }else
//        {
//            NSString *str = [NSString stringWithFormat:@"%@,为了更好的为您服务，使用本功能前请先绑定手机号",CUSTOMERMOBILE(customer_nickname)];
//            ALERT_VIEW(str);
//            _alert = nil;
//        }
...
//        if (self.userSexLabel.text.length == 0) {
            self.userSexLabel.text = @"先生";
//        }
...
//        }
        ...
        if (self.userPlaceLabel.text.length == 0) {
            self.userPlaceLabel.text = @"北京市";
