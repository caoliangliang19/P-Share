...
//    NSArray *endArray = [self.model.actualEndDate componentsSeparatedByString:@" "];
//    NSLog(@"%@===2==================1==%@",self.model.actualEndDate,self.model.actualBeginDate);
//    NSString *string = [self planMonthAndDay:self.model.actualBeginDate AndendDay:self.model.actualEndDate];
...
- (void)myanimation{
    ...
    {
        //拼接图片名字
        NSString *name = [NSString stringWithFormat:@"paid%d.png",i];
        //创建图片
