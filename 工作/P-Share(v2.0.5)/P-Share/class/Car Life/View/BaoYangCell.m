...
- (void)setUpSubView
{
    ...
    _titleL = titleL;
    titleL.textColor = [MyUtil colorWithHexString:@"3eb5f3"];
    ...
    subTitleL.textColor = [MyUtil colorWithHexString:@"999999"];
...
//        make.size.mas_equalTo(CGSizeMake(76, 76));
    ...
    [subTitleL mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.leading.mas_equalTo(titleL.leading);
        make.trailing.mas_equalTo(titleL.trailing);
