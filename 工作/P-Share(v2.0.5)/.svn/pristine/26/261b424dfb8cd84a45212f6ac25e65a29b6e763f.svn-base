...
- (void)setModel:(TemParkingListModel *)model
{
    _model = model;
...
- (void)backVC
{
    UIAlertController *alert = [MyUtil alertController:@"返回将丢失编辑内容,是否返回?" Completion:^{
...
{
    MyLog(@"X:%f  Y:%f",_scrollView.contentOffset.x,_scrollView.contentOffset.y);
...
{
    _style = style;
    if (style== CommentVCStyleOne) {
        
    }else if (style == CommentVCStyleTwo){
...
{
    UILabel *headTopLabel = [MyUtil createLabelFrame:CGRectZero title:@"总体评价" textColor:[MyUtil colorWithHexString:@"333333"] font:[UIFont systemFontOfSize:17] textAlignment:0 numberOfLine:1];
    _headTopLabel = headTopLabel;
    UILabel *headBottomLabel = [MyUtil createLabelFrame:CGRectZero title:@"车管家" textColor:[MyUtil colorWithHexString:@"333333"] font:[UIFont systemFontOfSize:17] textAlignment:0 numberOfLine:1];
...
- (void)setHeadViewStyleOne
{
    ...
    topLabel.textColor = [MyUtil colorWithHexString:@"333333"];
...
- (void)layoutCenterView
{
    ...
    UILabel *centerL = [MyUtil createLabelFrame:CGRectZero title:@"来自星星的标签" textColor:[MyUtil colorWithHexString:@"999999"] font:[UIFont systemFontOfSize:14] textAlignment:1 numberOfLine:0];
    _centerL = centerL;
...
- (void)loadBottomView
{
    ...
    textView.layer.borderColor = [MyUtil colorWithHexString:@"e0e0e0"].CGColor;
    textView.font = [UIFont systemFontOfSize:14];
    textView.text = placeHoldString;
    textView.textColor = [MyUtil colorWithHexString:@"999999"];
...
- (void)CommitComment
{
    ...
    if (_style == CommentVCStyleOne) {
        ...
        dic = [NSMutableDictionary dictionaryWithObjectsAndKeys:_model.orderId,@"orderId",[MyUtil getCustomId],@"customerId",[self changeNSInterget:_startView.lightingStartNum],@"totalityStar",totalComment,@"totalityTag",_textView.text,@"commentContent",@"2.0.1",@"version", nil];
    }else if (_style == CommentVCStyleTwo){
