...
- (void)setUpSubView
{
    ...
    self.backgroundColor = [MyUtil colorWithHexString:@"e4f6ff"];
    [self.layer setBorderColor:[MyUtil colorWithHexString:@"3eb5f3"].CGColor];
    ...
    [titleL setTextColor:[MyUtil colorWithHexString:@"335a7f"]];;
    titleL.font = [UIFont systemFontOfSize:12];
    [self sd_addSubviews:@[leftImage,rightImage,titleL]];
...
- (void)removeNotificationView
{
    if (self.removeNotificationViewBlock) {
        self.removeNotificationViewBlock();
    }
