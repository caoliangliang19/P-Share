...
- (void)setUpViews
{
    UILabel *weedLabel = [self createLabelWithTitle:nil Color:[MyUtil colorWithHexString:@"333333"] WithFont:13 withBackGroundColor:[UIColor whiteColor]];
    UILabel *dateLabel = [self createLabelWithTitle:nil Color:[UIColor whiteColor] WithFont:13 withBackGroundColor:[MyUtil colorWithHexString:@"39d5b8"]];
    ...
    UILabel *moneyLabel = [self createLabelWithTitle:nil Color:[MyUtil colorWithHexString:@"39d5b8"] WithFont:13 withBackGroundColor:[UIColor whiteColor]];
    moneyLabel.font = [UIFont boldSystemFontOfSize:13];
    
    UILabel *timeLabel = [self createLabelWithTitle:nil Color:[MyUtil colorWithHexString:@"333333"] WithFont:13 withBackGroundColor:[UIColor whiteColor]];
    _weedLabel = weedLabel;
    _dateLabel = dateLabel;
    _moneyLabel = moneyLabel;
    _timeLabel = timeLabel;
    [self sd_addSubviews:@[_weedLabel,_dateLabel,_moneyLabel,_timeLabel]];
    ...
    [_weedLabel makeConstraints:^(MASConstraintMaker *make) {
...
- (void)setStyle:(ChooseTimeViewStyle)style
{
    ...
    if (style == ChooseTimeViewStyleSelect) {
        _weedLabel.textColor = [MyUtil colorWithHexString:@"333333"];
        _dateLabel.textColor = [UIColor whiteColor];
        _dateLabel.backgroundColor = NEWMAIN_COLOR;
        _dateLabel.layer.borderColor = NEWMAIN_COLOR.CGColor;
        _moneyLabel.textColor = NEWMAIN_COLOR;
        _moneyLabel.font = [UIFont boldSystemFontOfSize:13];
        _dateLabel.font = [UIFont boldSystemFontOfSize:13];

        _timeLabel.textColor = [MyUtil colorWithHexString:@"333333"];
        
        
    }else if (style == ChooseTimeViewStyleUnSelect){
        _weedLabel.textColor = [MyUtil colorWithHexString:@"aaaaaa"];
        _dateLabel.textColor = [MyUtil colorWithHexString:@"aaaaaa"];
        _dateLabel.backgroundColor = [UIColor whiteColor];
        _moneyLabel.font = [UIFont systemFontOfSize:13];
        _dateLabel.font = [UIFont systemFontOfSize:13];

        _dateLabel.layer.borderColor = [MyUtil colorWithHexString:@"aaaaaa"].CGColor;
        _moneyLabel.textColor = [MyUtil colorWithHexString:@"aaaaaa"];
        _timeLabel.textColor = [MyUtil colorWithHexString:@"aaaaaa"];
