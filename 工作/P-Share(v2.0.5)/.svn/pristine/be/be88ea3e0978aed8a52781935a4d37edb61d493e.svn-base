...
- (void)setDataWithModel:(TemParkingListModel *)model
{
...
- (void)loadBottomL
{
    ...
    UILabel *label = [MyUtil createLabelFrame:CGRectZero title:@"" textColor:[MyUtil colorWithHexString:@"696969"] font:[UIFont systemFontOfSize:14] textAlignment:0 numberOfLine:0];
    _bottomLabel = label;
