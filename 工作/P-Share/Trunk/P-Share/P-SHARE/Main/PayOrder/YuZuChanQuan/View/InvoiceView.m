...
//    _select = @"0";
    ...
    self.invAddressField.layer.borderColor = [UIColor colorWithHexString:@"e0e0e0"].CGColor;
    self.invHeadField.layer.borderColor = [UIColor colorWithHexString:@"e0e0e0"].CGColor;
