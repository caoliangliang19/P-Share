...
@interface BusyDaiBoAlert ()

@property (nonatomic,strong) UIView *bgView;

@end
@implementation BusyDaiBoAlert
...
- (instancetype)init {
    ...
    if (self) {
        ...
        self = [[[NSBundle mainBundle]loadNibNamed:@"BusyDaiBoAlert" owner:nil options:nil]lastObject];
        ...
        self.bounds = CGRectMake(0, 0, 281, 258);
