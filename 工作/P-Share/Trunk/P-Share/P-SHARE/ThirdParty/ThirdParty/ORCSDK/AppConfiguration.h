 ...
 */
static NSString * const APP_KEY = @"23463569";

/**
 *  Api绑定的的AppSecret，用来做传输数据签名使用，可以在“阿里云官网”->"API网关"->"应用管理"->"应用详情"查看
 */
static NSString * const APP_SECRET = @"8123d6cf5d8f8acf14ef23ae5956ff37";

/**
 *  Api绑定的域名，只包含域名和端口号
 *  比如：baidu.com:8080
 */
static NSString * const APP_HOST = @"dm-52.data.aliyun.com";
