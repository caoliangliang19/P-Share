...
#define Green   [UIColor colorWithHexString:@"29d6b8"]
#define Purple  [UIColor colorWithHexString:@"8957a1"]
#define Orangle [UIColor colorWithHexString:@"faa952"]
#define Gray    [UIColor colorWithHexString:@"e0e0e0"]
