...
- (void)setUpSubView
{
    ...
    textField.attributedPlaceholder = [UtilTool getLableText:@"请输入停车场名称" changeText:@"请输入停车场名称" Color:[[UIColor whiteColor] colorWithAlphaComponent:0.8] font:14];
    textField.textColor = [UIColor whiteColor];
//    textField.placeholder = @"请输入停车场名称";
    textField.tintColor = KMAIN_COLOR;
